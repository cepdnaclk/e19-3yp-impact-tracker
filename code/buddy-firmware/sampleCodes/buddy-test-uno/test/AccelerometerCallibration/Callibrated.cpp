...
void setup(void)
{
    ...
    */
    acce.setRange(/*Range = */ DFRobot_LIS::eH3lis200dl_200g);
...
void loop(void)
{
    ...
    float resultant = sqrt(cx * cx + cy * cy + cz * cz);
    ...
    Serial.print(String(cx, 1));
    Serial.print(",");
    Serial.print(String(cy, 1));
    Serial.print(",");
    Serial.print(String(cz, 1));
    Serial.print(", Total: ");
    Serial.println(String(resultant, 1));

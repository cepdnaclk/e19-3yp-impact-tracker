...
A = np.array([[1.123014, 0.002365, -0.058250],  # 'A^-1' matrix from Magneto
              [0.002365, 1.222311, 0.104310],
              [-0.058250, 0.104310, 0.917551]])

# 'Combined bias (b)' vector from Magneto
b = np.array([-1.025426, -0.945815, 1.204207])

# Read raw data and apply calibration
rawData = np.genfromtxt('acceldata.txt',

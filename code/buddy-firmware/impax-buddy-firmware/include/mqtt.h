...
public:
    ...
    void init(String id, bool (*communicationDashboard)(), void (*turnOffHandler)()); // Initialize the MQTT client
    void reconnect(bool (*communicationDashboard)(), void (*turnOffHandler)());       // Reconnect to the MQTT broker

...
class PlayerController {
  ...
  // create player
  async createPlayer(email: string, password: string): Promise<PlayerResponse> {
    try {
  ...
  //get player details
  async getPlayer(playerEmail: string): Promise<PlayerResponse> {
    try {
  ...
  async getTeamsForPlayer(playerEmail: string): Promise<Array<TeamResponse>> {
    try {
